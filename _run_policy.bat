...
set "SOGEN_LDRNAME=1"
set "SOGEN_POLICY_DEBUG=1"
cd /d "C:\dev\tokon\tools\sogen\build\release\artifacts"
analyzer.exe -v --backend whp --whp-exec-hook int3 -r registry --env SteamAppId 4835540 --env SteamGameId 4835540 --env EOS_USE_ANTICHEATCLIENTNULL 1 --env ALLUSERSPROFILE "C:\ProgramData" --env ProgramData "C:\ProgramData" "D:\SteamLibrary\steamapps\common\MTFSOpenBeta\MTFS\Binaries\Win64\MTFSSteamOpenBeta-Win64-Shipping.exe"
