...
namespace sogen::py
{
    ...
    void register_windows_runtime_bindings(nb::module_& m)
    {
        ...
        bind_callback_property<&callback_registry::suspicious_activity_cb>(callbacks_class, "on_suspicious_activity",
                                                                           "suspicious_activity");
        ...
        nb::class_<sogen_windows_emulator>(m, "Emulator")
            ...
            .def("setup_process_if_necessary", &sogen_windows_emulator::setup_process_if_necessary,
                 nb::call_guard<nb::gil_scoped_release>())
            .def("yield_thread", &sogen_windows_emulator::yield_thread, nb::arg("alertable") = false,
                 nb::call_guard<nb::gil_scoped_release>())
