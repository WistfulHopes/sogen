...
namespace sogen
{
    ...
    namespace syscalls
    {
        namespace
        {
            constexpr std::u16string_view k_product_options_key =
                u"\\registry\\machine\\system\\CurrentControlSet\\Control\\ProductOptions";
        ...
        NTSTATUS handle_NtQueryLicenseValue(const syscall_context& c,
